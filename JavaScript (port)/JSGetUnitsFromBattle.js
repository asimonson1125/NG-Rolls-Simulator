function generate(x, attacking, unitnum, continent, defType){
    ...
    if(!attacking){ //defending
        ...
        ret += `unit${unitnum} = new unitClass.unit("${type}",${x.unit_off_str},${x.unit_def_str},${x.unit_speed},${x.unit_max_health},${locationBonus},[${typeBonus}],[${counters}],[${heals}],${shots});\n`;
    }
    else{ //attacking
        x.unit_stats.forEach(function(i){ 
        ...
        ret += `eunit${unitnum} = new unitClass.unit("${type}",${x.unit_off_str},${x.unit_def_str},${x.unit_speed},${x.unit_max_health},${locationBonus},[${typeBonus}],[${counters}],[${heals}],${shots});\n`;
    }
    return(ret);
}
